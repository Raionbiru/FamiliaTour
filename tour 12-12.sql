...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-12-2019 a las 20:36:48
...
(1, 'Prueba Cliente', 'Apellido Uno', 'ejemplo@gmail.com', '957894123', 'pruebacliente', 'PERU MISTIKA TRAVEL', '21478945610', '', 'www.perumistikatravel.com', 'A00001', 1, 1),
...
(14, 'Enrique', 'Mendoza Martinez', 'Las Orquideas 307', 'enrique.mendoza@gmail.com', NULL, '999666333', NULL, 42869788, 'Empleado', NULL, '123', 0, 0, 1),
...
INSERT INTO `programacion` (`id_prog`, `fec_prog`, `hora_prog`, `id_bus`) VALUES
(1, '2019-12-09', '09:00:00', 2),
(2, '2019-12-12', '10:00:00', 2),
(5, '2019-12-13', '12:00:00', 2),
(6, '2019-12-10', '15:00:00', 2),
(7, '2019-12-11', '08:00:00', 2),
(8, '2019-12-14', '11:00:00', 2);
...
INSERT INTO `reserva` (`id_reserva`, `fec_reserva`, `hora_reserva`, `id_cliente`, `id_prog`, `id_tour`) VALUES
(1, '2019-12-09', '10:26:10', 1, 6, 29);
...
--
ALTER TABLE `persona`
  MODIFY `id_per` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

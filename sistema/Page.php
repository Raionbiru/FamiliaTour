                                ...
                                <div class="account-box">
                                    <div class="text-center account-logo-box">
                                        <h2 class="text-uppercase">
                                            ...
                                            <span><img src="assets/images/transparent-logo2019.png" alt="" height="80"></span>
                                            </a>
                                        </h2>
                                    </div>
                                    <div class="account-content">
                                        <div class="text-center">
                                            ...
                                            <svg id="Layer_1" class="svg-computer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.2 424.2">
                                                <style>
                                                    .st0{fill:none;stroke:#4489e4;stroke-width:5;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
                                                </style>
                                                <g id="Layer_2">
                                            ...
                                            <h4 class="text-custom">El sitio está en mantenimiento</h4>
                                            <p class="text-muted">Estamos haciendo que el sistema sea más impresionante. Volveremos en breve.</p>
                                        </div>

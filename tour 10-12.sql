...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-12-2019 a las 16:57:25
...
(9, 'Johnn', 'Condori', 'johnn.condori@tecsup.edu.pe', '', '123', 'johnn', '', '', 'http://localhost/FamiliaTour/sistema/ADmi.php', NULL, 0, 1);
...
(3, 'Usuario Prueba', 'Apellido', NULL, 'ejemplo@gmail.com', NULL, '952786546', NULL, NULL, 'Empleado', 'usuarioprueba', 'usuarioprueba', 1, 1, 3),
(4, 'Otro Usuario', 'Apellido', NULL, 'ejemplo2@gmail.com', NULL, '987456159', NULL, NULL, 'Empleado', 'otrousuario', 'otrousuario', 1, 1, 1),
(5, 'Prueba', 'Tres', 'Paucarpata', 'ejemplo3@gmail.com', NULL, '987456159', NULL, NULL, 'Empleado', 'pruebatres', 'pruebatres', 1, 1, 2),
(6, 'Usuario Cuatro', 'Usuario', 'Paucarpata', 'ejemplo4@gmaiil.com', NULL, '987456123', NULL, NULL, 'Empleado', 'usuariocinco', 'usuariocinco', 1, 1, 1),
(7, 'operaciones', 'prueba', NULL, 'ejemplo6@gmail.com', NULL, '987587159', NULL, NULL, 'Usuario para probar ', 'operaciones', 'operaciones', 1, 1, 2),
(8, 'comercial', 'usuario prueba', NULL, 'ejemplo7@gmail.com', NULL, '987456123', NULL, NULL, 'Probar opciones come', 'comercial', 'comercial', 1, 1, 1),
(9, 'Condori', 'Johnn ', 'Mariano Melgar', 'johnn.condori@tecsup.edu.pe', NULL, '959349075', NULL, 73050189, 'Empleado', 'johnn.condori@tecsup.edu.pe', '123', 0, 0, 2);
...
INSERT INTO `servicioplus` (`id_serv_plus`, `nom_serv_plus`, `tipo_serv_plus`, `prec_serv_plus`, `prec_var_serv_plus`) VALUES
(1, 'Servicio de Viaje', 'Basico', '10', '15'),
(2, 'Servicio de Viaje', 'Superior', '20', '25'),
(3, 'Transporte de Evacuación', NULL, '10', '15'),
(5, 'Grabacion y Edicion de Viaje', 'Basico', '10', '15'),
(6, 'Grabacion y Edicion de Viaje', 'Avanzado', '20', '25'),
(7, 'Grabacion y Edicion de Viaje', 'Profesional', '30', '35');
...
(5, 'Terrestre', 'Privado', 'Lima', 'Cajamamrca', '250', '400'),
(7, 'Terrestre', 'Privado', 'Ejemplo2', 'Este', '12', '34');
...
--
ALTER TABLE `hostal`
  MODIFY `id_hostal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `persona`
  MODIFY `id_per` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
